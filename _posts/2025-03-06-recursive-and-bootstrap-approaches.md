...
The Figure below illustrates the weekly evolution of 'Variable X' over time, with the Y-axis representing its $$B$$ coefficient. This is a good example of sustained consistency over time.
